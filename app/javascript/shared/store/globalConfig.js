...
const {
  ...
  DISABLE_CHATWOOT_HUB: disableChatwootHub,
  FORCE_CTRL_ENTER_FOR_MESSAGES: forceCtrlEnterForMessages,
...
const state = {
  ...
  disableChatwootHub: parseBoolean(disableChatwootHub),
  forceCtrlEnterForMessages: parseBoolean(forceCtrlEnterForMessages),
